...
class DeliveriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create delivery" do
    assert_difference('Delivery.count') do
      post deliveries_url, params: { delivery: { shipping_company_id: @delivery.shipping_company_id, status: @delivery.status } }
    end
  ...
  test "should update delivery" do
    patch delivery_url(@delivery), params: { delivery: { shipping_company_id: @delivery.shipping_company_id, status: @delivery.status } }
